...
const RecentPage = () => {
  ...
  return (
    <div className="flex min-h-screen" style={{backgroundColor: '#e0e7ff'}}>
      {/* Sidebar */}
      <div className="w-60 bg-white border-r px-4 py-6" style={{width: '240px', backgroundColor: 'white', borderRight: '1px solid #e5e7eb', padding: '24px 16px'}}>
        <h1 className="text-3xl font-extrabold mb-6" style={{fontSize: '30px', fontWeight: '800', marginBottom: '24px'}}>
          DMS
        </h1>
      ...
      <main className="flex-1 px-8 py-6" style={{flex: '1', padding: '24px 32px'}}>
        ...
        <h2 className="text-xl font-semibold mb-6" style={{fontSize: '20px', fontWeight: '600', marginBottom: '24px'}}>
